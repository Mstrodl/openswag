...
public class BaseComponent extends TileEntity implements ITickable, ManagedEnvironment {
  ...
  public BaseComponent(String name, EnvironmentHost host) {
    isUpgrade = true;
    componentName = name;
    container = host;
    setupNode();
  ...
  protected void initOCFilesystem(String path, String name) {
    oc_fs = li.cil.oc.api.FileSystem.asManagedEnvironment(li.cil.oc.api.FileSystem.fromClass(OpenSwag.class, OpenSwag.MODID, path), name);
